...
class ExceptionHandler {
    ...
    fun handleNotFoundException(ex: NotFoundException): ResponseEntity<HttpExceptionResponse> {
        return createExceptionResponseEntity(ex)
    }

    @ExceptionHandler(ValidationException::class)
    fun handleValidationException(ex: ValidationException): ResponseEntity<HttpExceptionResponse>{
        return createExceptionResponseEntity(ex)
    }
